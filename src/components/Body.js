...
const Body = () => {
  ...
  return allRestaurants.length === 0 ? (
    ...
    <>
      <div className="w-[100vw] md:w-[80vw] flex flex-col justify-center">
        <div className="bg-slate-50 flex  flex-col items-center justify-center ">
          <div className="hero-section  relative md:h-[30rem] h-[20rem] flex  items-center w-full">
            <img
            ...
            <div className="my-12 flex flex-grow items-center justify-center  z-[2] ">
              <div className="flex justify-between w-2/3 sm:w-1/3 border border-slate-600 border-1 focus:w-2/3 rounded-lg overflow-hidden   ">
                <input
          ...
          <div className="w-[100vw] p-5">
            <div className="filterHeader lg:px-12 md:px-4 border-b-2 flex md:justify-between  my-8 ">
              <span className="text-[1rem] md:text-[26px] font-semibold  text-gray-800 whitespace-nowrap">
                {filteredRestaurants.length} restaurants
              </span>
              <div
                className="filterList flex flex-col md:flex-row md:gap-4 gap-1 px-2  text-slate-600 whitespace-nowrap font-semibold"
            ...
            <div
              className="restaurant flex md:flex-row flex-col md:flex-wrap justify-center  "
