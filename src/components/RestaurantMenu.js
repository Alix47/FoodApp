    ...
    <>
      <div className="menu-page flex-1 caret-transparent ">
        <div className="bg-slate-50 w-full">
          {/* hero-section */}
          <div className="res-details font-poppins flex gap-10 flex-wrap justify-center bg-[#171a29] text-white my-10 p-5 sm:p-10 ">
            <img
              loading="lazy"
            ...
            <div className="">
              <span
                className="block font-semibold text-xl mb-4 max-sm:mt-5 max-sm:ml-4 max-sm:text-sm"
              >
                {restaurantDetails.name}
              </span>
              <span className="ml-1 max-sm:ml-4 max-sm:text-sm">
                {restaurantDetails.cuisines.join(", ")}
              </span>
              <div className="flex  justify-between gap-3 sm:gap-12 pt-5 font-semibold text-base mt-7">
                <div className=" pr-3 sm:pr-9 border-r-[1px] border-white">
          ...
          <div className=" new-menu  xl:pxx-[23rem] pl-10">
            <div className="header text-[18px] sm:text-[26px] font-semibold border-b-gray-800  text-gray-800 w-full border-b pb-2 pl-7 font-poppins">
              Menu
            </div>
            <div className="category-menu flex pt-2 max-h-fit">
                    ...
                    .map((category, index) => {
                      if ("categories" in category) {
                        ...
                        return (
                          <li
                            key={index + category.title}
                            className="py-2 px-2 sm:px-6 category-name"
                          >
                            {category.title +
                              " (" +
              ...
              <div className={`menu flex-1 flex max-sm:w-60 max-h-[120vh] `}>
                <div
                  className="menu-wrapper flex-1 px-3 sm:px-8 font-poppins bg-white overflow-y-auto  "
