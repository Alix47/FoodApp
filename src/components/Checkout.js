  ...
  return (
    <div className="flex-grow bg-slate-50">
      {!cartItems.length ? (
        ...
        <>
          <div className="flex max-sm:flex-col sm:w-full font-poppins h-full border overflow-x-auto ">
            <div className="left flex-grow flex-auto w-[50%] min-w-[50%] flex flex-col ml-40 sm:ml-16 mt-8 ">
